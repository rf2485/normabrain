...
def test_bidscoiner(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/bidscoiner/config")
        data_path = Path(".tests/unit/bidscoiner/data")
        expected_path = Path(".tests/unit/bidscoiner/expected")
