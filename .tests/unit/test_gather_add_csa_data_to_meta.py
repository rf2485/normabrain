...
def test_gather_add_csa_data_to_meta(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/gather_add_csa_data_to_meta/config")
        data_path = Path(".tests/unit/gather_add_csa_data_to_meta/data")
        expected_path = Path(".tests/unit/gather_add_csa_data_to_meta/expected")
